...
class StandartRenkine(Renkine): 
    """Стандартный цикл Ренкина, состоящий из 6 точек с перегревом пара""" 
    ...
    def _point_4(self):
        ...
        self.S_4_point, self.H_4_point = self._get_nearest_point(
            self.S_saturation[self.max_index:], self.H_saturation[self.max_index:], 
        ...
        self.S_ren = np.linspace(self.S_4_point, self.S_5_point, 100)
